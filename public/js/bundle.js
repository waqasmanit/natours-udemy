...
var signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(name, email, password, confirmPassword, role) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 8:
            ...
            if (_context3.t0.response.data.error.name == 'MongoError') {
              (0, _alerts.showAlert)('error', 'Email already exist');
            } else (0, _alerts.showAlert)('error', _context3.t0.response.data.message.split(':')[2]);
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoid2FxYXNiY2EiLCJhIjoiY2tpaG82dno5MDFqeTJycXBzOTdmMDBxcCJ9.KujDdut5qAlsWIeKcr6VfQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/waqasbca/ckijnu1z405e517r1v4h3ho28',
    scrollZoom: false
  });
...
var stripe = Stripe('pk_test_51I5PgyKYw8n8qH9kcm9ULISrgClHaPTawxUaBzmLTMefshQSrnBp5yLPxXfXlTnFQlHXdC0Q3MEBMmpNMiyABZrA00uTxTOIfI');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _login.signup)(name, email, password, confirmPassword, role);
  });
}
